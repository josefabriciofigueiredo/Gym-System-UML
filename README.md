...
| **RF**   | **Descrição** |
|----------|---------------|
| **RF001** | O sistema deve cadastrar o aluno, somente presencialmente com o atendente (CPF, Nome, data de nascimento, telefone, e-mail, preferências de treino). Caso tenha mais pessoas da família, opta para o plano familiar e adicione os seus dependentes. |
...
| **RF006** | O sistema deve permitir ao Professor/Aluno que cancele a avaliação técnica agendada. |
| **RF007** | O sistema deve permitir que o aluno agende a avaliação técnica, com disponibilidade baseada nos horários dos professores. |
| **RF008** | O sistema deve permitir ao aluno que veja as avaliações técnicas e sua evolução. |
| **RF009** | O sistema deve permitir todos os alunos que visualizem o cronograma da academia (Horários de treinos, eventos e feriados). |
| **RF010** | O sistema deve permitir ao professor que registre o treino do aluno, marcando o professor que fez o registro. |
| **RF011** | O sistema deve permitir aos professores que possam editar os treinos colocando vídeos ou guias para os alunos. |
| **RF012** | O sistema deve permitir ao aluno que possa ver seu treino. |
| **RF013** | O sistema deve permitir ao aluno que edite o seu treino ou monte um do zero. |
| **RF014** | O sistema deve registrar os históricos dos treinos. |
| **RF015** | O sistema deve enviar uma notificação da mensalidade (Por meio de e-mail com um prazo de uma semana antes, três dias antes e no dia do vencimento), permitindo pagamento por boleto, PIX, cartão de crédito/débito. Caso seja pago em dinheiro, o atendente deve marcar no sistema o pagamento. |
| **RF016** | O sistema deve permitir ao aluno que acesse o histórico de pagamentos realizados e pendentes (Data, método de pagamento e valor). |
| **RF017** | O sistema deve liberar a passagem do aluno da catraca, caso as mensalidades estejam pagas. Se ocorrer alguma falha no sistema, o atendente poderá liberar manualmente. |
| **RF018** | O sistema deve permitir ao aluno que veja seus status financeiros. |
| **RF019** | O sistema deve bloquear o aluno caso tenha mensalidades pendentes e avisá-lo por meio de e-mail, no app/site permite visualizar a mensalidade pendente. |
| **RF020** | O sistema deve permitir ao administrador que gerencie os funcionários com a criação das contas e defina se é Professor ou Atendente. |
| **RF021** | O sistema deve permitir ao administrador que veja os históricos das frequências dos alunos e a popularidade nos treinos. |
| **RF022** | O sistema deve permitir ao administrador que atualize as mensalidades e planos da academia e avise os alunos (Por meio de e-mail) com um mês de antecedência à mudança. |
| **RF023** | O sistema deve permitir ao administrador que adicione o cronograma da academia, notificando caso ocorra algum evento ou feriado por e-mail. |
...
![Diagrama de Casos de Uso](./Diagramas/Diagrama%20de%20Casos%20de%20Uso.jpg)
...
![Diagrama de Sequência-01](./Diagramas/Diagrama%20de%20Sequência-01.jpg)

![Diagrama de Sequência-02](./Diagramas/Diagrama%20de%20Sequência-02.jpg)

![Diagrama de Sequência-03](./Diagramas/Diagrama%20de%20Sequência-03.jpg)

![Diagrama de Sequência-04](./Diagramas/Diagrama%20de%20Sequência-04.jpg)

![Diagrama de Sequência-05](./Diagramas/Diagrama%20de%20Sequência-05.jpg)
